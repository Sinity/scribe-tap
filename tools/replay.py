...
def main() -> None:
    ...
    parser.add_argument("--log-dir", type=Path, default=Path("/realm/activity/keylog/logs"))
    parser.add_argument("--snapshot-dir", type=Path, default=Path("/realm/activity/keylog/snapshots"))
    parser.add_argument(
        "--date",
        type=str,
